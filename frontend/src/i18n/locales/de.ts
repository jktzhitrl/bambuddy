export default {
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedPlate: 'Keine Vorlage mehr zum Kopieren',
      strandedNotice: 'Von den {{owed}} noch offenen Durchläufen lassen sich {{runs}} nicht einreihen: Für diese Platte gibt es keinen eingereihten oder abgeschlossenen Durchlauf mehr, von dem sich die Einstellungen kopieren lassen. Reihe die Platte einmal aus der Datei ein oder brich den Auftrag ab.',
    ...
    cancelBatchConfirmMessage: 'Diesen Auftrag schließen? Noch eingereihte Durchläufe werden abgebrochen, und er fordert nicht länger, was er nicht produziert hat.',
    batch: {
      defaultName: 'Stapel',
      label: '{{count}} Eintrag',
    ...
    toast: {
      ...
      keptForOrder: 'Abgebrochen statt entfernt: Nur aus diesem Durchlauf kann der Stapelauftrag diese Platte erneut einreihen',
      historyKeptForOrders: '{{kept}} behalten, die Stapelaufträge noch brauchen.',
